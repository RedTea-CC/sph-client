  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="(adress, index) in addressInfo"
        :key="adress.id"
      >
      ...
      <div class="detail">
        ...
        >
          ...
          <li>
            <p style="width: 420px">{{ order.skuName }}</p>
            <h4>7天无理由退货</h4>
          </li>
          <li>
    ...
    <div class="sub clearFix">
      <a class="subBtn" @click="subnitOrder">提交订单</a>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      async subnitOrder() {
        ...
        //其余的六个参数
        let data = {
          onsignee: this.userDefaultAddress.consignee, //最终收件人的名字
        ...
        if (result.code == 200) {
          ...
          // this.$router.push({ path: '/pay', query: { this.orderId }})
        } else {
